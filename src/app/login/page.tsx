...
//   return (
//     <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-[#f9f6f0] to-[#e4e0c8]">
//       <Card className="w-full max-w-md shadow-2xl p-6 rounded-2xl border border-gray-200 bg-white">
//         <CardHeader>
//           <CardTitle className="text-center text-3xl font-bold text-gray-800">
//             Login
...
//               <Button className="w-full bg-gradient-to-r from-coffee-500 to-coffee-400 text-white py-3 rounded-lg shadow-lg transition-transform transform hover:scale-105">
//                 Login
//               </Button>
...
//       <Card className="w-full max-w-md shadow-2xl p-6 rounded-2xl border border-gray-200 bg-white">
//         <CardHeader>
//           <CardTitle className="text-center text-3xl font-bold text-[#150d0a]">
//             Login
//           </CardTitle>
//         </CardHeader>
//         <CardContent className="space-y-6">
...
//           ) : (
//             <div className="space-y-4">
//               <Label className="text-[#2b1b16]">Email</Label>
//               <Input
//                 type="email"
//                 placeholder="Enter your email"
//                 className="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
...
//               <Label className="text-[#2b1b16]">Password</Label>
//               <Input
//                 type="password"
//                 placeholder="Enter your password"
//                 className="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
...
//               <p className="text-[#2b1b16] text-sm text-center">Or login using MetaMask</p>
        ...
        <CardContent className="space-y-6">
          {!role ? (
            <div className="space-y-4">
              <Button
                onClick={() => setRole("user")}
                className="w-full bg-gradient-to-r from-gray-700 to-gray-600 text-white py-3 rounded-lg shadow-lg transition-transform transform hover:scale-105"
              >
                Login as User
              </Button>
              <Button
            ...
            <div className="space-y-4">
              ...
              <Button className="w-full bg-gradient-to-r from-gray-700 to-gray-600 text-white py-3 rounded-lg shadow-lg transition-transform transform hover:scale-105">
                Login
              </Button>
              ...
              <Button
                variant="ghost"
                className="w-full bg-gradient-to-r from-gray-600 to-gray-800 text-white py-3 rounded-lg shadow-lg transition-transform transform hover:scale-105"
                onClick={() => setRole(null)}
              >
                Back
              </Button>
