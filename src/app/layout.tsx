...
//       <body className={`${geistSans.variable} ${geistMono.variable} antialiased`}>
//         {/* Navbar */}
//         <nav className="bg-gradient-to-br from-[#edc6ab] to-[#ffffff] text-white p-6 shadow-lg">
//           <div className="max-w-7xl mx-auto flex justify-between items-center">
//             {/* Logo Section */}
//             <Link href="/" className="flex items-center space-x-2">
...
//   {[
//     { href: "/", label: "Home" },
//     { href: "/dashboard/therapist", label: "Therapist Dashboard" },
...
//       key={item.href}
//       href={item.href}
//       className="relative px-4 py-2 text-gray-800 transition-all duration-300 ease-in-out rounded-lg group"
//     >
//       {/* Beige Background with Smooth Scaling */}
//       <span className="absolute inset-0 bg-[#725530] rounded-lg opacity-0 scale-95 transition-all duration-300 ease-in-out group-hover:opacity-100 group-hover:scale-105"></span>
